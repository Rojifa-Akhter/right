...
<head>
    ...
    <title> Farmers || Agrion || Agrion HTML 5 Template </title>
    <!-- favicons Icons -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__content">
                                <h3 class="team-one__title"><a href="farmers.html">David Cooper</a></h3>
                                <p class="team-one__subtitle">Senior Farmer</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__content">
                                <h3 class="team-one__title"><a href="farmers.html">Jessica Eve</a></h3>
                                <p class="team-one__subtitle">Senior Farmer</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="600ms">
                        <div class="team-one__single">
                            ...
                            <div class="team-one__content">
                                <h3 class="team-one__title"><a href="farmers.html">Mike Hardson</a></h3>
                                <p class="team-one__subtitle">Senior Farmer</p>
                            </div>
                        </div>
                    </div>
