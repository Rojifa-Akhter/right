...
<body>
    ...
    <div class="container">
        <h1 class="mt-5 mb-4">location List</h1>
            ...
            <form action="{{ route('update_location') }}" method="post" class="form-inline">
                ...
                <div class="form-group">
                    ...
                    <input type="text" autocomplete="off" class="form-control" id="country_name" name="country_name"
                        placeholder="Enter location Name" value="{{ $location_info->country_name }}">
                ...
                <div class="mb-3 row">
                    ...
                    <input type="text" autocomplete="off" class="form-control" id="district_name" name="district_name" 
                        placeholder="Enter district_name" value="{{ $location_info->district_name }}">
                ...
                <div class="mb-3 row">
                    ...
                    <input type="text" autocomplete="off" class="form-control" id="city_name" name="city_name" 
                        placeholder="Enter city_name" value="{{ $location_info->city_name }}">
                    <span id="city_nameError" class="text-danger"></span>
                </div>

                <div class="card-footer">
                    <button type="submit" class="btn btn-primary">Update</button>
                    <a href="{{ route('location_list') }}"><button type="button" class="btn btn-primary">Go
                            Back</button></a>
                </div>
            </form>
        </div>
