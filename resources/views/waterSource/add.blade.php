...
<body>
    ...
    <div class="container">
        <h1 class="mt-5 mb-4">Add waterSource</h1>
        <div class="mb-3 input-group">
            <form method="post" action="{{ route('waterSource_add_action') }}" onsubmit="return validateForm()" >
                @csrf
                <div class="mb-3 row">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary">Submit</button>
                     <a href="{{ route('waterSource_list') }}">  <button type="button" class="btn btn-primary">Go Back</button> </a>
